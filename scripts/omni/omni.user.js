...
// @namespace    omni-core
// @version      1.0.0
// @description  Omni — Voyager (stable injector) + Orbit (Hub+API+GUI+Loader) harmanlanmış tek dosya. Self-check public @version, güncel değilse fullscreen, güncel ise Orbit (w.Orbit) + pluginler.
...
(function () {
    ...
    const VOYAGER_URL = 'https://raw.githubusercontent.com/yusifmuradliroot/grimorium-of-gartic.io/main/scripts/omni/omni.user.js';
    const VOYAGER_FALLBACK = 'https://cdn.jsdelivr.net/gh/yusifmuradliroot/grimorium-of-gartic.io@main/scripts/omni/omni.user.js';
    ...
    const GITHUB_URL = 'https://github.com/yusifmuradliroot/grimorium-of-gartic.io/blob/main/scripts/omni/omni.user.js';
    ...
    function loadOrbit() {
        // Omni harman: Orbit embedded, fetch yok
        if (ORBIT_CODE.indexOf(ORBIT_MUST_CONTAIN) === -1) { console.error('[omni] embedded orbit mustContain fail'); return; }
        execOrbit(ORBIT_CODE, 'embedded:orbit');
